...
def build_html(meta: dict, units: list[dict], report_name: str) -> str:
    payload = json.dumps({"meta": meta, "units": units})
...
def main(argv: list[str]) -> int:
    ...
    out_path.write_text(build_html(meta, units, report_path.name))
