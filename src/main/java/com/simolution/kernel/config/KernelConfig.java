...
public final class KernelConfig {
    ...
    public static final double SELF_MASS_SCALE = 10.0;

    public static final double INITIAL_MASS = 1.0;
    public static final double MAINT_PER_MASS = 0.5;
    public static final double GROW_MAX = 5.0;
    public static final double GROW_HALF_SATURATION = 1.0;
    public static final double GROW_YIELD = 0.8;
