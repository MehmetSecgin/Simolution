...
11. Later: CROWDING/EMIT + quorum, multi-resource + stoichiometry, fluctuating/patchy inflow, biomass as a distinct variable (Pirt), sub-gene/selfish-DNA/whole-genome-duplication indel variants (contract-v4 omissions).
