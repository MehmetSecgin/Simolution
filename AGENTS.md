...
13. Later: CROWDING/EMIT + quorum, multi-resource + stoichiometry, fluctuating/patchy inflow, sub-gene/selfish-DNA/whole-genome-duplication indel variants, catabolism + corpse decomposition + multi-cell bodies (contract-v5 omissions).
