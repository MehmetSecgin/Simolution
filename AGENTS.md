...
12. Later: report-v10 (surface mass in report/CSV/map), CROWDING/EMIT + quorum, multi-resource + stoichiometry, fluctuating/patchy inflow, sub-gene/selfish-DNA/whole-genome-duplication indel variants, catabolism + corpse decomposition + multi-cell bodies (contract-v5 omissions).
